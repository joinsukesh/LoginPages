$(document).ready(function () {
    ...
    $(document).on("submit", "#LoginForm", function () {
        ...
        if (username == "admin" && password == "pass") {
            $(".bounceInLeft").removeClass("bounceInLeft").addClass("bounceOutRight");
            $(".bounceInRight").removeClass("bounceInRight").addClass("bounceOutLeft");
            $(".fadeInUpBig").removeClass("fadeInUpBig").addClass("fadeOutUpBig");
